...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen fьr Nachrichten CColorListCtrl 
...
void CColorListCtrl::OnPaint() 
{
	...
	if( (GetStyle() & LVS_TYPEMASK) == LVS_REPORT )
	{
        ...
        pen.CreatePen( PS_DOT, 1, GetColorRef(DEF_DESELTEXT) );
